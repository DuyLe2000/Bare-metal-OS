...
void uart_init()
{
	...
	*UART0_CR = 0x0;
	 ...
	 * Note: With latest test, the uart0 still work well without clock setting.
	 * However, we can keep it to have a identified baud rate (more meaningful with real board)*/
